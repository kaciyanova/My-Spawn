...
/***/ function(module, exports, __webpack_require__) {
	...
	const appActions = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const AppDispatcher = __webpack_require__(4);
	const appConstants = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const Serializer = __webpack_require__(5);
	const messages = __webpack_require__(7);
	const electron = __webpack_require__(2);
	'use strict';
	  ...
	  ipcMain.on(messages.DISPATCH_ACTION, (event, payload) => {
	    ...
	    if (!event.sender.isDestroyed() && event.sender.hostWebContents) {
	      ...
	      if (!queryInfo.windowId) {
	        let win = __webpack_require__(2).BrowserWindow.fromWebContents(event.sender.hostWebContents);
	        if (!win) {
	          return;
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	const mapValuesByKeys = __webpack_require__(8).mapValuesByKeys;
...
/***/ }
/******/ ]);
//# sourceMappingURL=lib.devTools.js.map