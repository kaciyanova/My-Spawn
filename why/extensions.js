//////////////////////////////////////////////////////////////////////////////////////////
////////////////////search 'MANUAL EXTENSIONS' to get 2 ur meaty meats////////////////////
//////////////////////////////////////////////////////////////////////////////////////////
...
// Enable HMA
  extensionInfo.setState('HMA', extensionStates.REGISTERED)  
  loadExtension('HMA', getExtensionsPath('HMA'))

// Enable Honey
  extensionInfo.setState('Honey', extensionStates.REGISTERED)  
  loadExtension('Honey', getExtensionsPath('Honey'))

// Enable Momentum
  extensionInfo.setState('Momentum', extensionStates.REGISTERED)  
  loadExtension('Momentum', getExtensionsPath('Momentum'))

// Enable Scrobbler
  extensionInfo.setState('Scrobbler', extensionStates.REGISTERED)  
  loadExtension('Scrobbler', getExtensionsPath('Scrobbler'))

// Enable Search Preview
  extensionInfo.setState('Search Preview', extensionStates.REGISTERED)  
  loadExtension('Search Preview', getExtensionsPath('Search Preview'))

// Enable Send to Kindle
  extensionInfo.setState('Send to Kindle', extensionStates.REGISTERED)  
  loadExtension('Send to Kindle', getExtensionsPath('Send to Kindle'))

// Enable SuperSorter
  extensionInfo.setState('SuperSorter', extensionStates.REGISTERED)  
  loadExtension('SuperSorter', getExtensionsPath('SuperSorter'))

// Enable SwagButton
  extensionInfo.setState('SwagButton', extensionStates.REGISTERED)  
  loadExtension('SwagButton', getExtensionsPath('SwagButton'))

// Enable Tab Scissors
  extensionInfo.setState('Tab Scissors', extensionStates.REGISTERED)  
  loadExtension('Tab Scissors', getExtensionsPath('Tab Scissors'))

// Enable The Great Suspender
  extensionInfo.setState('The Great Suspender', extensionStates.REGISTERED)  
  loadExtension('The Great Suspender', getExtensionsPath('The Great Suspender'))

// Enable TopCashback
  extensionInfo.setState('TopCashback', extensionStates.REGISTERED)  
  loadExtension('TopCashback', getExtensionsPath('TopCashback'))

// Enable Trending Hider
  extensionInfo.setState('Trending Hider', extensionStates.REGISTERED)  
  loadExtension('Trending Hider', getExtensionsPath('Trending Hider'))

// Enable Tumblr Savior
  extensionInfo.setState('Tumblr Savior', extensionStates.REGISTERED)  
  loadExtension('Tumblr Savior', getExtensionsPath('Tumblr Savior'))

// Enable Turn Off The Lights
  extensionInfo.setState('Turn Off The Lights', extensionStates.REGISTERED)  
  loadExtension('Turn Off The Lights', getExtensionsPath('Turn Off The Lights'))

// Enable Unseen 
  extensionInfo.setState('Unseen ', extensionStates.REGISTERED)  
  loadExtension('Unseen ', getExtensionsPath('Unseen '))
